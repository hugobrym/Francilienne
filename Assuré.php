...
<!-- BOOTSTRAP STYLES-->
 ...
 <li>
                                <a href="assure_inscription.php">Ajout assuré</a>
                            </li>

      <?php
      $unControleur = new Controleur ("localhost","MLR1","root","");

 $lesAssures= $unControleur->selectAllAssure();
      include ("vue/vue_select_assure.php");


      

       include("vue/vue_delete_assure.php");
      if(isset($_POST['Su']))
      {

        $unControleur->deleteAssure($_POST['idpersonne']);
