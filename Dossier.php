 ...
 <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
  ...
  <body>
    ...
    <center>
      ...
      <li>
                                <a href="dossier_inscription.php">Ajout de Dossiers</a>
                            </li>
      <?php
      $unControleur = new Controleur ("localhost","MLR1","root","");
      $LesDossier= $unControleur->selectAllDossier();
          include ("vue/vue_selectdossier.php");

          
          
include("vue/vue_delete_dossier.php");
      if(isset($_POST['effa']))
      {
        
        $unControleur->deleteDossier($_POST['referenceD']);
