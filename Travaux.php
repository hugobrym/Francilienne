 ...
 <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
  ...
  <body>
    ...
    <center>
      ...
      <li>
                                <a href="travaux_inscription.php">Ajout Travaux </a>
                            </li>
      <?php
      $unControleur = new Controleur ("localhost","MLR1","root","");
      $LesTravaux= $unControleur->selectAllTravaux();
          include ("vue/vue_selecttravaux.php");


          
          include("vue/vue_delete_travaux.php");
      if(isset($_POST['efface']))
      {

        $unControleur->deleteTravaux($_POST['efface']);
