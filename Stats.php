 ...
 <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
  ...
  <body>
    ...
    <center>
      ...
      $LesVAssures= $unControleur->selectViewAss();
      include ("vue/vue_view_assure.php");

       $LesVUtil= $unControleur->selectViewUti();
      include ("vue/vue_view_utilisateur.php");

      $LesVMetreurs= $unControleur->selectViewMetr();
      include ("vue/vue_view_metreur.php");

      $LesVSocietes= $unControleur->selectViewSoc();
      include ("vue/vue_view_societe.php");
