 ...
 <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
  ...
  <body>
    ...
    <center>
      ...
      <h3> Liste des RDV </h3>
      <li>
                                <a href="rdv_inscription.php">Ajout RDV </a>
                            </li>
      <?php
      $unControleur = new Controleur ("localhost","MLR1","root","");

 $LesRDV= $unControleur->selectAllRDV();
          include ("vue/vue_selectrdv.php");

          

          include("vue/vue_delete_rdv.php");
      if(isset($_POST['eff']))
      {
        
        $unControleur->deleteRDV($_POST['idRDV']);
