  ...
  <body>
    ...
    <center>
      ...
      <h3> Liste des Sociétés </h3>
       <li>
            <a href="société_inscription.php">Ajout de société</a>
        </li>
      <?php
      $unControleur = new Controleur ("localhost","MLR1","root","");

       $lesSocietes= $unControleur->selectAllSociete();
      include ("vue/vue_select_societe.php");


      


      include("vue/vue_delete_societe.php");
      if(isset($_POST['Sup']))
      {

        $unControleur->deleteSociete($_POST['idDO']);
