 ...
 <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
  ...
  <body>
    ...
    <center>
      ...
      <h3> Liste des Métreurs </h3>
                            <li>
                                <a href="metreur_inscription.php">Ajout Metreur</a>
                            </li>      
      <?php
      $unControleur = new Controleur ("localhost","MLR1","root","");

       $lesMetreurs= $unControleur->selectAllMetreur();
      include ("vue/vue_select_metreur.php");


     

      include("vue/vue_delete_metreur.php");
      if(isset($_POST['Supp']))
      {

        $unControleur->deleteMetreur($_POST['idpersonne']);
